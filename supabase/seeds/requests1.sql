INSERT INTO "public"."Charities" ("c_name", "email", "created_at", "cid", "address", "zip_code", "city", "state", "phone_num") VALUES ('Helping Hands Foundation', 'contact@helpinghands.org', '2025-11-05 01:15:54.649418+00', '11111111-1111-1111-1111-111111111111', '123 Elm Street', '98104', 'Seattle', 'WA', '206-555-1234');
...
VALUES ('01111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Adult', 'Unisex');

INSERT INTO "public"."Electronics" ("item_id", "cid", "type")
VALUES ('02222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'Other');

INSERT INTO "public"."Food" ("item_id", "cid", "storage_reqs")
VALUES ('03333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'Fridge');

INSERT INTO "public"."Furniture" ("item_id", "cid", "type")
VALUES ('04444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'Seating');

INSERT INTO "public"."HouseholdGoods" ("item_id", "cid", "type")
VALUES ('05555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'Cleaning Supplies');

INSERT INTO "public"."HygieneProduct" ("item_id", "cid")
VALUES ('06666666-6666-6666-6666-666666666666', '11111111-1111-1111-1111-111111111111');

INSERT INTO "public"."MedicalSupplies" ("item_id", "cid", "type")
VALUES ('07777777-7777-7777-7777-777777777777', '11111111-1111-1111-1111-111111111111', 'First Aid');

INSERT INTO "public"."SchoolOfficeSupplies" ("item_id", "cid")
VALUES ('08888888-8888-8888-8888-888888888888', '11111111-1111-1111-1111-111111111111');

INSERT INTO "public"."SportsEquipment" ("item_id", "cid", "type")
VALUES ('09999999-9999-9999-9999-999999999999', '11111111-1111-1111-1111-111111111111', 'Other');

INSERT INTO "public"."ToysGames" ("item_id", "cid", "age_group")
VALUES ('0aaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'All Ages');