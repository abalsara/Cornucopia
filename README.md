...
- **Create Account / Sign In** – Users can register a new account or sign in to access their profile and donation features.
- **View Profile** – Users can view their account information in their profile.
- **Search / Browse Local Charities** – Users can browse charities nearby.
- **View Charity Details Page** – Users can access a charity’s page to learn about its mission, causes, reviews, location, etc...
- **View Charity Needs** – Users can see the current items that a charity needs.
- **Add Items to Donation** – Users can select specific items from a charity’s needs list to add to their donation.
- **Schedule Donation**– Donor can schedule a donation
- **View Donation Details** – Donor can view donation details (location, date, time, donation items)
